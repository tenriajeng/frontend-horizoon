    ...
    return (
        <>
            <DialogSearch>
                ...
                >
                    <span className="line-clamp-1 flex-nowrap text-start">
                        {searchParams.has('q')
                            ? searchParams.get('q')
                            : 'Find Your Courses...'}
                    </span>
            ...
            <DialogSearch>
                <div
                    ...
                    aria-label="Search"
                    tabIndex="0"
                    className="flex h-9 w-9 items-center justify-center rounded-lg border hover:bg-slate-800 dark:bg-slate-950 md:hidden"
                >
